...
def inventory_menu(con, header, player, inventory_width, screen_width,
                   screen_height):
    # show a menu with each item if the inventory as an option
...
def level_up_menu(con, header, player, menu_width, screen_width,
                  screen_height):
    options = [f'Constitutuion (+20 HP, from {player.fighter.max_hp})',
...
def character_screen(player, character_screen_width, character_screen_height,
    ...
    libtcod.console_print_rect_ex(window, 0, 4, character_screen_width,
                                  character_screen_height, libtcod.BKGND_NONE,
                                  libtcod.LEFT,
                                  f'Experience to Level: '
                                  f'{player.level.experience_to_next_level}')
