...
class GameMap:
    ...
    def initialize_tiles(self):
        tiles = [[Tile(True) for u in range(self.height)]
    ...
    def make_map(self, max_rooms, room_min_size, room_max_size,
        ...
        for r in range(max_rooms):
            ...
            # random position without going out of bound
    ...
    def place_entities(self, room, entities):
        ...
        for i in range(number_of_monsters):
            ...
            if not any([entity for entity in entities
                ...
                monster_choise = random_choice_from_dict(monster_chances)

                if monster_choise == 'orc':
                    ...
                    monster = Entity(x, y, 'o', libtcod.desaturated_green,
                                     ...
                                     ai=ai_component)
                elif monster_choise == 'troll':
                    fighter_component = Fighter(hp=30, defense=2, power=8,
                                                xp=100)
                    ai_component = BasicMonster()
                    monster = Entity(x, y, 'T', libtcod.desaturated_green,
                                     'Troll', blocks=True,
                                     render_order=RenderOrder.ACTOR,
                                     fighter=fighter_component,
                                     ai=ai_component)
        ...
        for i in range(number_of_items):
            ...
            if not any([entity for entity in entities
                        if entity.x == x and entity.y == y]):
                item_choise = random_choice_from_dict(item_chances)

                if item_choise == 'healing_potion':
                    ...
                    item = Entity(x, y, '#', libtcod.red, 'Fireball Scroll',
                                  render_order=RenderOrder.ITEM,
                                  item=item_component)
                elif item_choise == 'confusion_scroll':
                    ...
                    item = Entity(x, y, '#', libtcod.light_pink,
                                  ...
                                  render_order=RenderOrder.ITEM,
                                  item=item_component)
                elif item_choise == 'lighting_scroll':
    ...
    def next_floor(self, player, message_log, constants):
        ...
        message_log.add_message(Message('You rest and recover your health',
